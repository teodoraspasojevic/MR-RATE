...
def save_as_niigz_v4(image: "sitk.Image", path: str):
    """No-denoise ablation variant: skip denoise_image() entirely, just clamp
    the resampled candidate and write it out, to isolate denoise's effect on
    local FVD scoring."""
    output = sitk.Clamp(image, lowerBound=-1000.0, upperBound=1000.0)
